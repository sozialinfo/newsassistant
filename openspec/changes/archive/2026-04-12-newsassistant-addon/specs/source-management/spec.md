...
The system SHALL provide a form view for `news.source` allowing editing of name, url, and active flag, with read-only display of state, last_scrape_date, error_message, and a list of related articles.
