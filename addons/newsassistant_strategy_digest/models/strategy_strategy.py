...
class StrategyStrategy(models.Model):
    ...
    prompt = fields.Text(
        ...
        readonly=True,
        help="AI-generated prompt that defines which articles are relevant and how to label them. "
             "Generated by the 'Distill Prompt' action.",
    )
    ...
    def action_distill_prompt(self):
        ...
        5. Save the combined evaluation prompt to strategy.prompt.
        """
        self.ensure_one()
